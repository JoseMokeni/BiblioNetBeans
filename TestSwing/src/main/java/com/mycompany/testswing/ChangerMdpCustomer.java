 ...
 * @author JOSE MOKENI
 */
public class ChangerMdpCustomer extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String hashedPwd = BCrypt.hashpw(password, "$2a$10$Y1wZ9xP/LbSmflX5.tvbNu");
        String confirmation = jPasswordField2.getText();
        if (password.equals(confirmation)){
            String sqlStaement = "UPDATE clients SET mdp = '"+hashedPwd+"' WHERE cin='"+cin+"';";
            try {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new CustomerSpace().setVisible(true);
        this.dispose();
